...
- Для мониторинга Linux-устройства нужен совместимый Linux-адаптер, отдающий аппаратный snapshot в формате проекта, с портом, открытым для подключения с устройства, на котором запущен HWFrontQML.
